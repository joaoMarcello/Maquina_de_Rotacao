'''
	=========================   ATIVIDADE DE INTRODUCAO A CRIPTOGRAFIA :: MAQUINA DE ROTACA0   ==============================
		Implementa a cifra de maquina de rotacao com tres cilindros, considerando o alfabeto com 
...
class Cilindro:
	...
	''' Funcao utilizada quando se pressiona um botao da maquina. Ela recebe um caractere e afuncao devolve outro.
		Recebe:
			- c: o caractere que foi pressionado
			- mode: 0 se deseja cifrar ou qualquer outro valor caso se deseje decifrar
		Retorna:
			- a letra para a cifragem/decifragem (dependendo do valor de mode) 
	'''
...
class MaquinaRotacao:
	...
	''' Simula o pressionar de um botao da maquina. Apertar um botao implica em fazer os cilindros rotacionarem.
		...
		Recebe:
			- c: o caractere que foi pressionado
		Retorna:
			- o caractere cifrado/decifrado, dependendo do modo em que maquina esta
	'''
	def press(self, c):
		if self.mode == 0:
	...
	def descriptografar(self, texto):
		...
		for i in range(t_size):
			...
			r = self.press(c)
			# concatenando o resultado com a string s
			s = r + s
